...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # চেক করুন ইউজার এডমিন/ম্যানেজার কি না
    is_admin = uid in staff_ids()
    
    # এআই থেকে রেসপন্স নিয়ে আসা
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith('play_fee_'):
        ...
        if opponent:
            ...
            p2_fee = opponent['fee']
            final_fee = min(fee, p2_fee) # Lowest common amount
            ...
            # ইউজারদের মেসেজে কত টাকার ম্যাচ হচ্ছে তা জানিয়ে দেওয়া হলো
